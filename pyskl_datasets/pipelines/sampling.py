...
class NW_UCLA_Original_Sample:
    ...
    def _get_train_clips(self, num_frames, clip_len):
        ...
        random_idx = random.sample(list(np.arange(length))*100, clip_len)
        random_idx.sort()
        idx = np.array(random_idx)
    ...
    def _get_test_clips(self, num_frames, clip_len):
        ...
        length = num_frames
        idx = np.linspace(0,length-1,clip_len).astype(np.int)
